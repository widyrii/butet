...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Butet'S</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Moduls</span>
          ...
          <ul class="treeview-menu">
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> Master Cake
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{url('/master_cake/add')}}"><i class="fa fa-circle-o"></i> Add</a></li>
                <li><a href="{{url('/master_cake/table')}}"><i class="fa fa-circle-o"></i> Table</a></li>
           ...
           <ul class="treeview-menu">
            <li>
              <a href="#"><i class="fa fa-circle-o"></i> Cake
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{url('/cake/add')}}"><i class="fa fa-circle-o"></i> Add</a></li>
                <li><a href="{{url('/cake/table')}}"><i class="fa fa-circle-o"></i> Table</a></li>
          ...
          <ul class="treeview-menu">
            <li>
              <a href="{{url('/contact/table')}}"><i class="fa fa-circle-o"></i> Table
                <span class="pull-right-container"></span>
              </a>
            </li>
          </ul>
        </li>
        <li><a href="{{url('/shipping/table')}}"><i class="fa fa-book"></i> <span>Booking Data</span></a></li>
